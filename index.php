    ...
    <div class="container">
        ...
        <div class="row p-5  align-items-center" >
               ...
               <div class="col-md-6 text-center p-3">
                   <img src="assets/images/eduhub-hero.png" class="img-fluid w-80" alt="">
               </div>
           </div> 
    </div>
 </section>
    ...
    <div class="container">
        <div class="row "> 
            ...
            <div class=" resource-box col-md-3 m-2 ">
                <div class="p-1">
                    <img src="assets/images/icon1.png" alt="" class="img-fluid mx-auto d-block">
            ...
            <div class=" resource-box col-md-3 m-2 ">
                <div class="">
                    <img src="assets/images/icon2.png" alt="" class="img-fluid mx-auto d-block">
            ...
            <div class=" resource-box col-md-3 m-2 ">
                <div class="">
                    <img src="assets/images/icon4.png" alt="" class="img-fluid mx-auto d-block">
                    <p class="fw-bold text-center">
